...
class UpdateEnterpriseActionExecutionCapabilitySettingInput(sgqlc.types.Input):
    ...
    capability = sgqlc.types.Field(
        sgqlc.types.non_null(ActionExecutionCapabilitySetting),
        graphql_name="capability",
    )
    client_mutation_id = sgqlc.types.Field(String, graphql_name="clientMutationId")
...
class EnterpriseOwnerInfo(sgqlc.types.Type):
    ...
    pending_collaborators = sgqlc.types.Field(
        sgqlc.types.non_null("EnterprisePendingCollaboratorConnection"),
        graphql_name="pendingCollaborators",
        args=sgqlc.types.ArgDict(
            (
                ("query", sgqlc.types.Arg(String, graphql_name="query", default=None)),
                (
                    ...
                    sgqlc.types.Arg(
                        ...
                        graphql_name="orderBy",
                        default={"field": "INVITEE_LOGIN", "direction": "ASC"},
                    ),
                ),
                ("after", sgqlc.types.Arg(String, graphql_name="after", default=None)),
                (
...
class EnterprisePendingCollaboratorConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("EnterprisePendingCollaboratorEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(sgqlc.types.list_of("User"), graphql_name="nodes")
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null("PageInfo"), graphql_name="pageInfo"
...
class RegistryPackageConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackage"), graphql_name="nodes"
    )
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null(PageInfo), graphql_name="pageInfo"
    )
...
class RegistryPackageDependencyConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageDependencyEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageDependency"), graphql_name="nodes"
    )
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null(PageInfo), graphql_name="pageInfo"
    )
...
class RegistryPackageFileConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageFileEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageFile"), graphql_name="nodes"
    )
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null(PageInfo), graphql_name="pageInfo"
    )
...
class RegistryPackageTagConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageTagEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageTag"), graphql_name="nodes"
    )
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null(PageInfo), graphql_name="pageInfo"
    )
...
class RegistryPackageVersionConnection(sgqlc.types.relay.Connection):
    ...
    __field_names__ = ("edges", "nodes", "page_info", "total_count")
    edges = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageVersionEdge"), graphql_name="edges"
    )
    nodes = sgqlc.types.Field(
        sgqlc.types.list_of("RegistryPackageVersion"), graphql_name="nodes"
    )
    page_info = sgqlc.types.Field(
        sgqlc.types.non_null(PageInfo), graphql_name="pageInfo"
    )
...
class Blob(sgqlc.types.Type, Node, GitObject):
    ...
    is_binary = sgqlc.types.Field(
        sgqlc.types.non_null(Boolean), graphql_name="isBinary"
    )
    is_truncated = sgqlc.types.Field(
        sgqlc.types.non_null(Boolean), graphql_name="isTruncated"
    )
...
class Milestone(sgqlc.types.Type, Node, Closable, UniformResourceLocatable):
    ...
    issue_priorities_debug = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="issuePrioritiesDebug"
    )
    issues = sgqlc.types.Field(
        sgqlc.types.non_null(IssueConnection),
        graphql_name="issues",
...
class PullRequest(
    ...
    # FIXME This was added by hand to easier determine PR uniquenes, but it would be
    # nicer if this could work without modifying this since it can be autogenerated
